			...
			<section class="slider text-center" id="slider">
				<div class="modal-dialog ">
					...
					<div class="modal-body" >
						...
						<form method="POST" action="registration.php"> 
							<div class="form-group">
								<label><i class="fa fa-user fa-2x"></i>&nbspTài Khoản :</label>
								<input type="text" name="name" class="form-control">

								<label><i class="fa fa-lock fa-2x"></i>&nbspMật khẩu :</label>
								<input type="text" name="password" class="form-control" id="pwd">

								<label><i class="fa fa-user fa-2x"></i>Nhập lại mật khẩu :</label>
					...
					<div class="right-box">
						...
						<button id="btn-signup"><a id="sign" href="index.php">Trở lại</a></button>
				</div>
			</div>
			</section>
