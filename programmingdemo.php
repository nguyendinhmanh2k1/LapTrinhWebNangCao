...
.div1                           /* for title image*/
{
   ...
   position: relative;
    height: 500px;
    width: 1263px;
    background:url(uploadimg/programming_1.jpg);
}
        ...
        <div class="container">
          <div class="row row-30">
            <div class="col-md-4 col-xl-5">
              <div class="pr-xl-4"><a class="brand" href="index.html">Math ManhND</a>
                <!-- Rights-->
                <p class="rights"><span>©  </span><span class="copyright-year">2022</span><span> </span><span>MathManhND</span><span>. </span><span>All Rights Reserved.</span></p>
              </div>
            </div>
            <div class="col-md-4">
              <h5>Contacts</h5>
              <dl class="contact-list">
                <dt>Address:</dt>
                <dd>Thôn Vĩnh Lộc 1 Phùng Xá, Thạch Thất, Hà Nội</dd>
              </dl>
              <dl class="contact-list">
                <dt>email:</dt>
                <dd><a href="mailto:#">nguyendinhmanh19815521@gmail.com</a></dd>
              </dl>
              <dl class="contact-list">
                <dt>phones:</dt>
                <dd><a href="tel:#">+84 357519815</a> <span>or</span> <a href="tel:#">+84 987030240</a>
                </dd>
              </dl>
            </div>
